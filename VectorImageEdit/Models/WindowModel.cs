...
namespace VectorImageEdit.Models
{
    class WindowModel
    {
        public void WorkspaceResize(Size newDimensions)
        {
            ...
            graphicsMan.UpdateFrame(layerMan.WorkspaceLayers, RenderingPolicyFactory.FullUpdate());
        }
        public void AppWindowMove()
        {
            ...
            AppModel.Instance.LayerManager.RefreshFrame(RenderingPolicyFactory.FullUpdate());
        }
    }
}
